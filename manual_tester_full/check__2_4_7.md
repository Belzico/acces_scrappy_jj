...
def check_focus_visible(html_content, page_url, excel="issue_report.xlsx"):
    ...
    Incluye campos 'result' y 'expected_result' en cada incidencia.
    """
    ...
    for element in focusable_elements:
        ...
        # 1) Detectar si el foco está oculto con CSS
        ...
        # 2) Detectar elementos interactivos sin tabindex correcto
        ...
        # 3) Detectar elementos con tabindex="-1" (los saca de la navegación)
        ...
        # 4) Detectar elementos que se ocultan al recibir foco
    ...
    # Generar el reporte en Excel con las incidencias detectadas
    if incidences:
